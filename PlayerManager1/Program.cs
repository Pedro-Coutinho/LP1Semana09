...
namespace PlayerManager1 // >>> Change to PlayerManager2 for exercise 4 <<< //
{
    ...
    public class Program
    {
        ...
        private void ShowMenu()
        {
            ...
            Console.WriteLine("3 - Players with score greater than x");
        ...
        private void ListPlayersWithScoreGreaterThan()
        {
            ...
            int score = Int32.Parse(Console.ReadLine());
            IEnumerable<Player> players = GetPlayersWithScoreGreaterThan(score);
            ListPlayers(players); 
        }
        ...
        private IEnumerable<Player> GetPlayersWithScoreGreaterThan(int minScore)
        {
            ...
            foreach(Player p in playerList){
                if(p.Score >= minScore) tempList.Add(p);
            }
